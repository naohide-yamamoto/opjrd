...
JATOS is not yet a public workflow. When exposed, this document should name the
target JATOS version used for validation and document any JATOS-specific
dependencies or deployment constraints.
