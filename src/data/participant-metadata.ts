...
import {
  getJatosMetadataValues,
  keepPrimitiveMetadataValues,
} from "../runtime/jatos";
...
function metadataValuesForProvider(
  ...
  switch (provider) {
    case "none":
      return {};
    case "form":
      return keepPrimitiveMetadataValues(source.formValues);
    case "jatos":
      return {
        ...getJatosMetadataValues(),
        ...keepPrimitiveMetadataValues(source.jatosValues),
      };
    case "manual":
      return {
        ...config.participantMetadata.manualValues,
        ...keepPrimitiveMetadataValues(source.manualValues),
      };
    case "url":
